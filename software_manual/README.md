...
* [void private Matrix::decompLU(LinearAlgebra::Matrix & L, LinearAlgebra::Matrix & U) const](https://github.com/chazcornwall/math4610/blob/master/software_manual/decompLUPrivate.md)
