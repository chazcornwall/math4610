...
**Description/Purpose:** This routine calculates the infinity norm of a column or row vector.
...
int main()
{
    ...
    double output = row.vectorlInfNorm();
...
**Implementation/Code:** The following is the code for vectorlInfNorm()
